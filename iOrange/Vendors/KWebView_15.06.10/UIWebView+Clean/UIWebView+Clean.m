...
- (void)cleanForDealloc {
    /*
     #1: Apple recommends setting the delegate to nil before deallocation:
    ...
    /*
     ...
     #2: Various developers believe UIWebView may not properly throw away child
    ...
    /*
     #3: Others claim that UIWebView's will leak if they are loading content
     during dealloc.
